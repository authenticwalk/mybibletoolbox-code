...
Number system captures grammatical number distinctions, including singular (one), dual (two), plural (more than two), and other number categories that languages may grammatically mark.
...
- [ ] Review existing feature analysis (check `../features-archive/number-system/`)
...
- **Previous Work**: [features-archive/number-system/](../features-archive/number-system/)
