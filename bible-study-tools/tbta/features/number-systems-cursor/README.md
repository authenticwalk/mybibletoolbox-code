...
- **Trial**: "Let us-three make" → Can indicate Trinity (Father, Son, Holy Spirit)
...
- **Slovenian**: Obligatory dual (most distinctive feature of the language)
  - `hiša` (one house) → `hiši` (two houses) → `hiše` (three+ houses)
- **Upper Sorbian**: Complete dual system (Bible translated 1728)
- **Lower Sorbian**: Dual preserved
- **Kashubian**: Dual preserved

**Historical Note**: 
- Biblical Hebrew had dual endings `יִם-` (-ayim) for paired body parts (eyes, ears, hands) and time periods
...
- **Classical Hebrew**: Dual for paired body parts (עֵינַיִם "eyes") and time periods (יוֹמַיִם "two days")
...
|-----------------|-----------|------|-------|--------|----------|----------|
| **Austronesian** | 176 | ✅ (~87 Oceanic) | ✅ (some Oceanic) | ✅ (some) | ⚠️ (2 contested) | **HIGH** |
| **Trans-New Guinea** | 129 | ✅ (very common) | ❌ | ✅ (some) | ❌ | **HIGH** |
| **Indo-European** | 135 | ✅ (4 Slavic only) | ❌ | ❌ | ❌ | **LOW** |
| **Australian** | 36 | ✅ (varies) | ❌ | ✅ (common) | ❌ | **MEDIUM** |
| **Afro-Asiatic** | 25 | ✅ (Classical only) | ❌ | ❌ | ❌ | **LOW** |
| **TOTAL** | **501+** | **~220+** | **~20-30** | **~50-70** | **2?** | — |
...
- **Position 2: Number (S/D/T/Q/p/P)** ← This feature
...
notes: "Hebrew uses plural verb נַֽעֲשֶׂה (na'aseh) and plural suffix -נוּ (-enu). TBTA marks as Trial (exactly 3) for Trinity reference. Languages with trial number should use trial form; languages without trial use plural with theological note."
...
number: "Dual"
notes: "Greek δύο (duo) explicitly states 2 persons. Dual-marking languages must use dual number."
...
- [ ] **Success Criteria**: 100% accuracy for stated values (with ≥100 verses per value)
...
- [ ] **4 Critical Peer Reviews**:
  ...
  - [ ] Methodological review (sample size ≥100/value, balanced sampling, locked predictions)
