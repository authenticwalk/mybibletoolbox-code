...
Discourse genre identifies the type of discourse or literary form being used, such as narrative, poetry, prophecy, legal text, wisdom literature, epistle, or apocalyptic literature.
...
- [ ] Review existing feature analysis (check `../features-archive/discourse-genre/`)
...
- **Previous Work**: [features-archive/discourse-genre/](../features-archive/discourse-genre/)
