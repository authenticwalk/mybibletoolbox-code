...
### Dryer, Matthew S. & Haspelmath, Martin (eds.) (2013). *World Atlas of Language Structures Online*
...
- {corbett-2000-number} Corbett, Greville G. (2000). *Number*. Cambridge University Press. [Cited in {tbta-source/CRITIQUE.md}]

- {wals-online} Dryer, Matthew S. & Haspelmath, Martin (eds.) (2013). *The World Atlas of Language Structures Online*. Leipzig: Max Planck Institute for Evolutionary Anthropology. https://wals.info/ (suspected)

**General Linguistic Knowledge** (not specifically cited but standard references):

- {greenberg-1963-universals} Greenberg, Joseph H. (1963). "Some Universals of Grammar with Particular Reference to the Order of Meaningful Elements". In *Universals of Language*, ed. Joseph H. Greenberg, 73-113. MIT Press.

- {comrie-1989-universals} Comrie, Bernard (1989). *Language Universals and Linguistic Typology* (2nd ed.). University of Chicago Press.

**Internal TBTA Sources**:

- {tbta-source/README.md} - Overview with language examples
...
- {tbta-source/CRITIQUE.md} - Validated experimental findings

**Note**: Web searches did not return relevant linguistic typology results (returned computing number systems instead). Scholarly content is based on general linguistic knowledge and TBTA documentation citations. Stage 2 should verify language-specific claims through translation data analysis.
