...
Polarity distinguishes between affirmative and negative expressions, including standard negation, double negatives, negative concord, and different scopes and types of negation in language.
...
- [ ] Review existing feature analysis (check `../features-archive/polarity/`)
...
- **Previous Work**: [features-archive/polarity/](../features-archive/polarity/)
