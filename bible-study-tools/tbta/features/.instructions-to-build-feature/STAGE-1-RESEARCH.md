...
- **Frequency Analysis**: Coverage per value (how often does each value appear?)

### 2. Language Family & Typology Analysis (The "Who")
**Location**: `research/languages/`
**Source**: `../../languages/`, WALS, Grambank
**Action**:
- **Identify Required Families**: List specific families (e.g., "Austronesian", "Bantu") that *grammatically require* this feature.
...
- **Identify Control Languages**: Which major languages (English, Spanish) *lack* this feature?
- **Select Candidates**: Propose 5-10 languages for the Translation Database (Stage 2) based on this analysis.
  - *Criteria*: Mix of marking vs. non-marking, diverse families, accessible via eBible.
...
**Output**: `experiments/ARBITRARITY-CLASSIFICATION.md`
...
**Requirement**: Distinguish between *Stylistic* (Arbitrary) and *Doctrinal* (Non-Arbitrary) choices.
**Structure**:
